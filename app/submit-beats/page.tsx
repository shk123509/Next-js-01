        ...
        <section className="py-16 md:py-24 bg-gray-950 text-white min-h-screen">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <header className="text-center mb-12">
                    <MusicalNoteIcon className="h-12 w-12 text-red-500 mx-auto" />
                    <h2 className="text-5xl md:text-6xl font-extrabold leading-tight mt-3">
                        Submit Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-red-500">Tracks for Review</span>
                    </h2>
                ...
                <div className="text-center mt-16 pt-8 border-t border-gray-800">
                    <h3 className="text-2xl font-bold text-white mb-4">
                        Already submitted? Check your dashboard.
                    </h3>
                    <a 
